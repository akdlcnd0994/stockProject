...
def get_top_gainers(market="J", limit=10):
    """상승률 상위 종목 조회
    ...
    params = {
        ...
        "FID_COND_SCR_DIV_CODE": "20171",  # 상승률 순위
        "FID_INPUT_ISCD": "0000",
        "FID_DIV_CLS_CODE": "0",
        "FID_BLNG_CLS_CODE": "0",
    ...
    if response.status_code == 200:
        ...
        if data.get("rt_cd") == "0" or data.get("rt_cd") == "":
            ...
            print(f"\n=== 상승률 상위 {min(limit, len(output))}종목 ===")
...
if __name__ == "__main__":
    ...
    print(f"{market_name} 상승률 상위 {limit}종목 조회 중...")
